...
<area id="Area1" onfocus="activate(this,true)" onblur="activate(this,false)" 
  ...
  <div id="pageContent" >
    ...
    <table cellpadding="0" cellspacing="0" border="0">
      ...
      <tr>
        ...
        <td valign="top"><div id="pageMainContent">
            ...
            <div class="txtPay">
						...
						<tr>
						<td colspan="3">
	  					<span align="left" class="pagesubtitle">You are making a payment to <span class="style1">AG Design</span>.</span>
  ...
  <!-- main table end -->
    ...
    <div id="footer">
      <div id="footer">
      <div id="footLeft"><br/>
          <span class="redColor">925.954.7084</span>  /  925 ygnacio valley road, suite 103c  /  walnut creek, california 94596  / copyright &copy; 2011 Ag design group, inc.  All rights reserved.   </div>
      <div id="footRight"> <img src="http://www.agdesigngroup.net/images2/AG_brands.jpg" alt="AG Design - Building Better Brands" /> </div>
    </div>
 ...
 <table  border="0" align="left" cellpadding="0" cellspacing="0" class="subNavTable" >
    ...
    <td width="167"></td>
     <?php
		  ...
		  for($num=0; $num<$varNumMain; $num++)
		  {
    	    ...
    	    <a href="http://www.linkedin.com/company/970221" target="_blank"><img src="images2/buttons/linkedin.jpg" style="float:left;margin-left:0px;" border="0" alt="AG on LinkedIn"/></a><a href="http://www.facebook.com/pages/AG-Design-Group/171121906244641" target="_blank"><img src="images2/buttons/facebook.jpg" style="float:left; margin-left:6px;" border="0" alt="AG on Facebook" /></a><a href="http://twitter.com/AGDesignGroup" target="_blank"><img src="images2/buttons/twitter.jpg" style="float:left; margin-left:6px;" border="0" alt="AG on Twitter" /></a>
        	</div>
			<?php			
			}
			?>
  ...
  <div id="AGlogo"><a href="../indexTEST.php"><img src="../images2/AG_design_logo.png" alt="AG Design" width="74" height="74" border="0" /></a></div>
</div> 
</td>
</tr></table>
<script>
