...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
        ...
        <style type="text/css">
       .main { color: #282828; font-size: 11px; font-family: Helvetica, Geneva, Arial, SunSans-Regular, 		sans-serif; line-height: 14px; text-decoration: none; margin-top: 5px; margin-right: 15px; margin-left: 25px; }

       .style3 { color: #282828; font-size: 11px; font-family: Helvetica, Geneva, Arial, SunSans-Regular, 		sans-serif; line-height: 14px; text-decoration: none; margin-top: 5px; margin-right: 15px; margin-left: 25px; }
		...
		<table width="744" border="0" cellspacing="0" cellpadding="0">
			...
			<tr height="412">
				<td align="left" valign="top" height="412">
						<table width="744" border="0" cellspacing="0" cellpadding="0">
					  <tr height="363">
								<td rowspan="2" width="500" height="412" valign="top">
            <!-- start main content -->
            <div class="main">
            <form name="MainForm" id="MainForm" method="post" action="">

  			<table align="center" border="0" bordercolor="eeeeee" cellpadding="3" width="500" height="412">
  			<tr>
				<td colspan="3">
	  		<span align="left" class="pagesubtitle">You are making a payment to <span class="style4">AG Design</span>.</span>
			<br/>
			<br/>		
  ...
  <!-- main table start -->
    <tr><td>
      <table align="left" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td height="24" colspan="3" class="style4">PAYMENT </td>
            </tr>
        <tr>
        ...
        <tr>
               <td height="30"><strong> Credit Card Type</strong></td>
              <td height="30"><strong> Verification No.</strong></td>
              <td height="30"><strong> &nbsp;</strong></td>
            </tr>
            
        <tr>
          <td> <select tabindex="9" name="cardtype" id="cardtype" >
         ...
         <td colspan="2"> <input name="cvv2Number" type="text" id="cvv2Number" tabindex="9" value="<?php echo $cvv2Number; ?>" size="5" maxlength="5" />
 </td>
            </tr>
        ...
        <tr>
          <td height="24" colspan="3" class="style4">BILLING INFORMATION</td>
            </tr>
        <tr>
