...
<span class="pagetitle"><?php echo ($deleting ? "DELETE" : "EDIT"); ?> from "<?php echo $page_title; ?>"</span>
    ...
    <td valign="top">
        ...
        <?php if( strlen($step1_title) > 0) { ?>
        <tr>
	  	<td valign="top" class="Bold"><div align="right"><strong>Video File</strong></div></td>
		<td>
         	<?php if( strlen($step1_title) > 0 ) { ?>
          	&nbsp;<a href="../<?php echo $PAGES_VIDEO_FOLDER . $step1_title;?>" target="_blank"><?php echo $baseURL . '/' . $PAGES_VIDEO_FOLDER . $step1_title;?></a>&nbsp;&nbsp;&nbsp;
		   	<br/>
         	<?php if( strlen($step2_title) > 0 ) { ?>
          	&nbsp;<a href="../<?php echo $PAGES_VIDEO_FOLDER . $step2_title;?>" target="_blank"><?php echo $baseURL . '/' . $PAGES_VIDEO_FOLDER . $step2_title;?></a>&nbsp;&nbsp;&nbsp;
          	<?php } ?>
		  	<input type="submit" name="changeVideo" id="changeVideo" value="Replace" />
            <input type="submit" name="deleteVideo" id="deleteVideo" value="Delete" />
		   	<?php } ?> 
             </td>
	  </tr>
		<?php 
		...
		?>  
            ...
            <tr>
                ...
                <td><input type="file" name="pdf_file" size="70" /></td>
            </tr>
            <tr>
                <td valign="top"><div align="right"><strong>Flash .flv File</strong></div></td>
                <td><input type="file" name="pdf_file2" size="70" /></td>
            </tr>
        <?php
		}
		?>
