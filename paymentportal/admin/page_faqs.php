  ...
  <table width="800" >
      <tr>
      	<td colspan="4">
            ...
            <tr>
            <td>
          <form id="form0" name="form0" method="post" action="page_faqs_add.php">
      ...
      <td class="tableHeadings" width="100">Display Order</td>
      	<td class="tableHeadings">Question	</span>        </td>
	  	...
	  	if( $varNumFAQs > 0 ) 
		{
         ...
         <tr>
            ...
            <form id="form<?php echo $row_rsFAQs['faq_id']; ?>" name="form<?php echo $row_rsFAQs['faq_id']; ?>" method="post" action="page_faqs_edit.php">
        <input type="hidden" name="page_id" value="<?php echo $page_id; ?>" />
        <input type="hidden" name="page_title" value="<?php echo $page_title; ?>" />
         <input type="hidden" name="faq_id" value="<?php echo $row_rsFAQs['faq_id']; ?>">
      	<td  class="tableFields" ><?php echo $row_rsFAQs['display_order']; ?>        </td>
        <td  class="tableFields" >
         
         <?php echo stripParagraphTags(stripslashes($row_rsFAQs['question'])); ?>         </td>
    ...
    <?php  
           } while ($row_rsFAQs = mysql_fetch_assoc($rsFAQs));
        }  
  ?>    
      </table>
  <br/>
