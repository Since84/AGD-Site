...
function updateHelp($db_database, $db_connection) 
{
	require "db_utils.php";

	// update existing item
	$updateSQL = sprintf("UPDATE help SET sort_by=%s, help_cat_id=%s, title=%s, resource_link=%s, description=%s, last_update=%s WHERE help_id=%s  LIMIT 1",
			   // id is NULL
			   ...
			   'NOW()',  // update_date
			   GetSQLValueString($_POST['help_id'], "text")
			   );		
