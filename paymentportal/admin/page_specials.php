  ...
  <table width="800" >
      <tr>
      	<td colspan="4">
            ...
            <tr>
            <td>
          <form id="form0" name="form0" method="post" action="page_specials_add.php">
            <input type="submit" name="add" id="add" value="Add Guide Page" />
            <input type="hidden" name="page_id" value="<?php echo $page_id; ?>" />
            <input type="hidden" name="page_title" value="<?php echo $page_title; ?>" />
         </form> 
         </td>
      ...
      <tr>
	  	...
	  	if( $varNumSpecials > 0 ) 
		{
         ...
         <tr>
            ...
            <form id="form<?php echo $row_rsSpecials['special_id']; ?>" name="form<?php echo $row_rsSpecials['special_id']; ?>" method="post" action="page_specials_edit.php">
        <input type="hidden" name="page_id" value="<?php echo $page_id; ?>" />
        <input type="hidden" name="page_title" value="<?php echo $page_title; ?>" />
         <input type="hidden" name="special_id" value="<?php echo $row_rsSpecials['special_id']; ?>">
      	 <td class="tableFields"  >
         
         <?php echo $row_rsSpecials['title']; ?> (<?php echo $row_rsSpecials['special_id']; ?>)        </td>
