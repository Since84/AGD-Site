...
function addNews($pdf_file, $image_file, $db_database, $db_connection) 
{
	require "db_utils.php";
	$active 		= ( $_POST['active'] == 'on' ? 1 : 0 );

	// adding an item
	$updateSQL = sprintf("INSERT INTO news VALUE (NULL, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
				   // id is NULL
				   ...
				   GetSQLValueString(addslashes($_POST['snippet']), "text"),
