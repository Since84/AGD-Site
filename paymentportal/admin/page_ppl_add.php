...
if( isset($_POST["ADDSTAFF"]) )
{
	...
	$desc_6		 	= stripslashes($_POST['desc_6']);	
	$desc_7		 	= stripslashes($_POST['desc_7']);	
	...
	if( empty($_POST['description'])  )
	{
		$msg = $msg . '<font color="red">Please enter a short bio.</font><br/>';
		$edits_ok = false;
	}
	...
	*/
	...
	if($edits_ok)
	{
		...
		if( $upload_ok )
		{
			...
			// now update database
			require('db_ppl_add.php'); 
			$product_id = addPerson($image_filename, $db_database, $db_connection);
...
<span class="pagetitle">ADD PERSON to "<?php echo $page_title; ?>"</span>
     ...
     <tr>
      ...
      <tr>
		...
		<td><input name="first_name" type="text" id="first_name" size="30" maxlength="50" value="<?php echo $_POST['first_name']; ?>"/></td>
	  </tr>
      <tr>
	  	<td valign="top" class="Bold"><div align="right">Last Name</div></td>
		<td><input name="last_name" type="text" id="last_name" size="30" maxlength="50" value="<?php echo $_POST['last_name']; ?>"/></td>
	  </tr>
       <tr>
       ...
       <tr>
		...
		<td><input name="phone" type="text" id="phone" size="30" maxlength="50" value="<?php echo $_POST['phone']; ?>"/></td>
	  </tr>
       <tr>
	  	<td valign="top" ><div align="right">Email</div></td>
		<td><input name="email" type="text" id="email" size="30" maxlength="50" value="<?php echo $_POST['email']; ?>"/></td>
	  </tr>
      <tr>
