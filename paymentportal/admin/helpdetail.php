...
<p><span class="pagetitle"><?php echo $row_rsHelp['title']; ?></span><br/>
 
 <?php echo stripslashes($row_rsHelp['description']); ?>
  <?php 
 // PDF FILE
 if( strlen($row_rsHelp['resource_link']) > 0 ) { ?>
 	<a href="<?php echo $row_rsHelp['resource_link']; ?>" target="_blank">Click here to view more information.</a>
    <br/><br/>
 <?php } ?>
 <?php 
 // PDF FILE
 if( strlen($row_rsHelp['resource_file']) > 0 ) { ?>
 	<a href="<?php echo $HELP_FOLDER . $row_rsHelp['resource_file']; ?>" target="_blank">Click here to download PDF</a>
    <br/><br/>
 <?php } ?>
