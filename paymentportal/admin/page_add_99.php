...
//------------------------------------------------------------------------------------------------------------------
 ...
 ?>
        <tr><td colspan="3" height="20" class="pageEditBars">&nbsp;&nbsp;WEBMASTER ONLY</td></tr>
       <tr>
      ...
      <tr>
	  	<td valign="top" ><div align="right">Body Include</div></td>
		<td colspan="2"><textarea name="snippet" cols="40" id="snippet"><?php echo $snippet; ?></textarea></td>
      </tr>
       <tr>
	  	<td valign="top" ><div align="right">Header Include</div></td>
