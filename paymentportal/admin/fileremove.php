...
if( isset($_POST["MM_delete"]) )
{
	...
	$updateSQL = sprintf("UPDATE %s SET pdf_file = NULL WHERE %s=%s",
	...
	$full_file_name = "../" . $PAGES_PDF_FOLDER . $_POST['pdf_file'];
	//echo $full_file_name;
...
// get image file name to show image
...
<table width="100%">
 ...
 <form enctype="multipart/form-data" id="form1" name="form1" method="post" >
      ...
      <input type="hidden" name="type_id" value="<?php echo $type_id; ?>">
       <input type="hidden" name="pdf_file" value="<?php echo $pdf_file; ?>">
  ...
  <?php echo $msg; ?>  </td>
      ...
      <tr>
		...
		<td colspan="3"><a href="<?php echo $baseURL . "/" . $PAGES_PDF_FOLDER . $pdf_file; ?>" target="_blank">Click here to view.</a>
          </td>
      </tr>
	  <tr>
	  	<td valign="top">&nbsp;</td>
