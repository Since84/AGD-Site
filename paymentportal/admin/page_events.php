  ...
  <table width="800" >
      <tr>
      	<td colspan="4">
            ...
            <tr>
            <td>
          <form id="form0" name="form0" method="post" action="page_events_add.php">
      ...
      <tr>
      <td class="tableHeadings" width="100">Event Date</td>
      	<td class="tableHeadings">Event Name</span>        </td>
      	<td class="tableHeadings">Location</span>        </td>
	  	...
	  	if( $varNumEvents > 0 ) 
		{
         ...
         <tr>
            ...
            <form id="form<?php echo $row_rsEvents['event_id']; ?>" name="form<?php echo $row_rsEvents['event_id']; ?>" method="post" action="page_events_edit.php">
        <input type="hidden" name="page_id" value="<?php echo $page_id; ?>" />
        <input type="hidden" name="page_title" value="<?php echo $page_title; ?>" />
         <input type="hidden" name="event_id" value="<?php echo $row_rsEvents['event_id']; ?>">
      	<td  class="tableFields" ><?php echo $row_rsEvents['event_date']; ?>        </td>
        <td  class="tableFields" >
         
         <?php echo stripslashes($row_rsEvents['event_name']); ?>         </td>
        <td  class="tableFields" >
         
         <?php echo stripParagraphTags(stripslashes($row_rsEvents['place'])); ?>         </td>
