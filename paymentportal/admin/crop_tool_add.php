...
if( isset($_POST["ADDSTAFF"]) )
{
	...
	if($edits_ok)
	{
		...
		if( $upload_ok )
		{
			...
			// now update database
			require('db_crop_tool_add.php'); 
			$product_id = addCropImage($image_filename, $db_database, $db_connection);
			...
			if( $isManualCrop )
			{
				...
				$_SESSION['returnURL'] = 'crop_tool.php';
			}
...
<span class="pagetitle">ADD Image to "<?php echo $page_title; ?>"</span>
       <table width="100%">
     <tr>
	  ...
	  <tr>
		...
		<td valign="top"><input name="group_id" type="text" id="group_id" size="30" maxlength="255" value="<?php echo $group_id; ?>"/></td>
	  </tr>
	  <tr>
	  	<td width="175" valign="top" ><div align="right">Display Order<br/>(within group)</div></td>
		<td width="513">
        <input name="sort_by" type="text" id="sort_by" size="30" maxlength="30" value="<?php echo $_POST['sort_by']; ?>"/> 
              </td>
	  </tr>
      <tr>
