...
<p><span class="pagetitle"> HELP TOPICS</span>
<br/><br/>
  <p>
  ...
  <td width="641" valign="top">
      ...
      <td width="534" valign="top">
        <span class="categorytitle"><a href="helpdetail.php?help_id=<?php echo $row_rsHelp['help_id']; ?>"><?php echo $row_rsHelp['title']; ?></a> </span>  </td>
      </tr>
   ...
   <td>
   <div id="tipTrick">
      <span class="pagetitle">Need additional help?</span><br />
      <br />
      <a href="support.php">&gt; Submit a support request.      </a></div>
   </td>
   </tr>
   </table>
        <p><br />
